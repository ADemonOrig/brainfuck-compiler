...
struct compiler
{
    ...
    void link() {
        ...
        string cmd = "\""s + path + "\\cc64.exe\" -I\"" + path + "\" -L\"" + path + "\" \"" + path + '\\' + middle + "\" -o \"" + output = '\"';
    ...
    void compile() {
        ...
        while (i < size) {
            if (code[i] == '+' || code[i] == '-') {
                ...
                if (count == 1) code += "    (*ptr)++;\n";
                else if (count == -1) code += "    (*ptr)--;\n";
                else if (count > 1) code += "    *ptr += " + to_string(count) + ";\n";
                else if (count < -1) code += "    *ptr -= " + to_string(-count) + ";\n";
            }
                ...
                if (count != 0) code += "    ptr = cells + ((ptr - cells + MC) % MC);\n";
            }
